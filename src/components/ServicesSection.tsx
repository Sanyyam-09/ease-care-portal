        ...
        >
          {services.map((service) => (
            <motion.div
              key={service.title}
              variants={item}
              className="card-premium group rounded-xl border border-border bg-card p-6 shadow-card cursor-pointer"
            >
              <div className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg transition-colors duration-300 ${service.color} ${service.hoverColor}`}>
